...
def start(message):
    send_mess = "<b>Здравствуйте! Данный бот был создан для покупки и продажи услуг в социальной сети Twiter." \
                " Вот что я умею</b>"
...
def help(message):
    send_mess = "Данный бот был создан для покупки ретвитов и лайков у популярных твиттерских. Если вы покупаете услугу," \
                " то вы должны подать заявку с указанием точного твита и действий с ним. Заявка будет рассмотрена " \
                "модераторами и при одобрении будет предлагаться твиттерским три дня, после чего будет деактивирована." \
